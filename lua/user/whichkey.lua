...
local setup = {
  plugins = {
    ...
    registers = false, -- registers slow down a lot..
    spelling = {
...
local mappings = {
  ...
  d = {
    name = "Debug",
    a = { "<cmd>lua require('dap').continue()<cr>", "Start Debug" },
    q = { "<cmd>lua require('dap').close()<cr>", "Close debug session" },
  ...
  l = {
    ...
    d = {
      "<cmd>Telescope diagnostics bufnr=0<cr><esc>",
